...
@section('content')
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="float-right">
                    <div class="btn btn-primary" id="refresh-tabel-pegawai"><span class="fas fa-sync-alt mr-1"></span>Refresh
                        Tabel</div>
                    <button class="btn btn-success" data-toggle="modal" data-target="#addpegawaimodal" id="pgwadduser"><span
                            class="fas fa-user-plus mr-1"></span>Tambah Pegawai</button>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered" id="datapegawai" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th>Nama Pegawai</th>
                                <th>Kode Pegawai</th>
                                <th style="max-width: 10%;">Pas Foto</th>
                                <th>Username</th>
                                <th>NPWP</th>
                                <th>Jenis Kelamin</th>
                                <th>Level</th>
    ...
    <!-- Modal Add Pegawai -->
    <div class="modal fade" id="addpegawaimodal" tabindex="-1" role="dialog" aria-labelledby="addpegawaimodal"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="addpegawaimodallabel"><span
                            class="fas fa-user-plus mr-1"></span>Tambah Pegawai</h5>
                </div>
                <form action="#" id="addpegawai" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group" id="show_hide_password">
                                    <input type="password" class="form-control" id="password_pegawai"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="instansi_pegawai" name="instansi_pegawai"
                                    ...
                                    title="Untuk mengubah nama instansi ini silakan buka pada bagian setting aplikasi"
                                    readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="tempat_lahir_pegawai"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="role_pegawai" class="form-control" id="role_pegawai">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="jenis_kelamin_pegawai" value="Laki - Laki"
                                        id='jenis_kelamin_pegawai' class='form-check-input' />
                                    <label class="form-check-label" for="jenis_kelamin_pegawai1">Laki - Laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="jenis_kelamin_pegawai" value="Perempuan"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="shift_pegawai" value="1" id='shift_pegawai'
                                        class='form-check-input' />
                                    <label class="form-check-label" for="shift_pegawai1">Full Time</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="shift_pegawai" value="2"
                                        class='form-check-input' />
                                    <label class="form-check-label" for="shift_pegawai2">Part Time</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="shift_pegawai" value="3"
                                        class='form-check-input' />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="verifikasi_pegawai" value="0"
                                        id='verifikasi_pegawai' class='form-check-input' />
                                    <label class="form-check-label" for="verifikasi_pegawai1">Belum Terverifikasi</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input type="radio" name="verifikasi_pegawai" value="1"
                                        class='form-check-input' />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <div class="custom-control custom-checkbox"><input class="custom-control-input"
                                        id="barcode_pegawai" type="checkbox" name="barcode_pegawai" /><label
                                        class="custom-control-label" for="barcode_pegawai">Dengan Barcode</label></div>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="addpgw-btn"><span
                                class="fas fa-plus mr-1"></span>Simpan</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- Modal View Pegawai -->
    <div class="modal fade" id="viewpegawaimodal" tabindex="-1" role="dialog" aria-labelledby="viewpegawaimodal"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="viewpegawaimodallabel"><span
                            class="fas fa-user-tie mr-1"></span>Preview Pegawai</h5>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal"><span
                            class="fas fa-times mr-1"></span>Tutup</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Modal Edit Pegawai -->
    <div class="modal fade" id="editpegawaimodal" tabindex="-1" role="dialog" aria-labelledby="editpegawaimodal"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="editpegawaimodallabel"><span
                            class="fas fa-user-edit mr-1"></span>Edit Pegawai</h5>
                </div>
                <div class="modal-body">
